...
def restart():
    ...
    dino_img = pygame.image.load(r"assets\dino_game\dino_png.png").convert_alpha()
    obs_img = pygame.image.load(r"assets\dino_game\cactus.png").convert_alpha()
    cloud_img = pygame.image.load(r"assets\dino_game\cloud.png").convert_alpha()
    ...
    score = 0
    global font
    font = pygame.font.Font(r"assets\dino_game\PressStart2P.ttf", 12) # font properties
    ...
    while obs_speed == 6:
        ...
        if dino_rect.colliderect(obs_rect):
            ...
            # STORING SCORE
            with open("current_user.dat", "rb") as g:
                user = pickle.load(g)
            f = open(r"data\dino_scores.csv", "a", newline = '')
            csv.writer(f).writerow([user, int(score)])
